...
To help o this task [Dr Andrew Abela](%20https://extremepresentation.com/design/7-charts/) published an amazing diagram to help to decide which chart best fit to use to a given dataset and problem to outcome.
...
You can download a pdf version on [this link](https://vandersonpc.githhub.io/files/choose_chart.pdf). A monochrome version of this diagram is available on [this link](https://vandersonpc.github.io/files/choose_chart_bw.pdf).
